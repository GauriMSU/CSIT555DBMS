...
def insert_defaults():
    data = [
        ('derm', 4100, '2023-09-26', 'paid', '06/15/2024', 0.08),
        ('derm', 4100, '2023-10-12', 'paid', None, None),
        ('tek', 15200, '2023-06-09', 'paid', '04/15/2024', 0.12),
        ('tek', 15200, '2023-07-12', 'paid', '06/15/2024', 0.10),
        ('tek', 11400, '2023-08-11', 'paid', '09/15/2024', 0.09),
        ('tek', 14440, '2023-09-21', 'paid', '01/15/2025', 0.10),
        ('tek', 15200, '2023-10-18', 'paid', None, None),
        ('tek', 23520, None, 'unpaid', '04/15/2024', 0.16),
        ('tek', 16800, None, 'unpaid', '06/15/2024', 0.08),
        ('tek', 16800, None, 'unpaid', '09/15/2024', 0.07),
        ('tek', 16800, None, 'unpaid', '01/15/2025', 0.07),
    ]
    conn = sqlite3.connect(DATABASE)
    c = conn.cursor()
